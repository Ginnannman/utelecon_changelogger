...
| 言語 | 状態 | 公開ページ | ソース |
|---|---|---|---|
| 日本語 | 変更なし | [`/utokyo_wifi/ios/`](<https://utelecon.adm.u-tokyo.ac.jp/utokyo_wifi/ios/>) | [`src/pages/utokyo_wifi/ios.mdx`](<https://github.com/utelecon/utelecon.github.io/blob/18e2245e0d9b23fb32fa12781b0265e26a44d251/src/pages/utokyo_wifi/ios.mdx>) |
| English | 変更 | [`/en/utokyo_wifi/ios/`](<https://utelecon.adm.u-tokyo.ac.jp/en/utokyo_wifi/ios/>) | [`src/pages/en/utokyo_wifi/ios.mdx`](<https://github.com/utelecon/utelecon.github.io/blob/18e2245e0d9b23fb32fa12781b0265e26a44d251/src/pages/en/utokyo_wifi/ios.mdx>) |

## English

```diff
  説明: Table of Contents: Preparation: Apply for the UTokyo Wi-Fi account; Procedures on iPhone and iPad...
  
- [UTokyo Wi-Fi](/en/utokyo_wifi/) > iPhoneやiPadで利用する
+ [UTokyo Wi-Fi](/en/utokyo_wifi/) > Using UTokyo Wi-Fi on iPhone and iPad
  # Using UTokyo Wi-Fi on iPhone and iPad
...
+ During configuration and while in operation, different content and procedures may be displayed in the Wi-Fi settings even for the same kind of OS. This page was created based on the behavior confirmed for some specific (iPhoneSE (2nd generation) with iOS 16.5) available at the time of creation of this page. Therefore, when necessary, please read the content and procedures for the respective device and OS version.
  ...
  ⋯
  ![](/_astro/ios-createprofile1.webp)![](/_astro/ios-createprofile2.webp)
  #### Supplement
