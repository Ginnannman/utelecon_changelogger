...
| 言語 | 状態 | 公開ページ | ソース |
|---|---|---|---|
| 日本語 | 変更 | [`/gen-ai/basics/responsible-use/`](<https://utelecon.adm.u-tokyo.ac.jp/gen-ai/basics/responsible-use/>) | [`src/pages/gen-ai/basics/responsible-use.md`](<https://github.com/utelecon/utelecon.github.io/blob/622296c7e37347cfdf4cc523c7c9c43c8fd31a20/src/pages/gen-ai/basics/responsible-use.md>) |
| English | — | — | — |

## 日本語

```diff
  タイトル: 責任あるAI利用 | utelecon
- 説明: 目次: はじめに; 虚偽、不正確情報（ハルシネーション）; 偏り; 著作権などの権利侵害; 低品質大量生産（AIゴミ）問題; 次に読むとよいページ...
+ 説明: 目次: はじめに; 虚偽，不正確情報（ハルシネーション）; 偏り; 著作権などの権利侵害; 低品質大量生産（AIゴミ）問題; 次に読むとよいページ...
